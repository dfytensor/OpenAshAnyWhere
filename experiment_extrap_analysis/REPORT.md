...
*实验日期: 2026-06-05*
*脚本: analyze_layer_state.py, ablation_state.py, bench_fixed_extrap.py, bench_oa_fix.py, bench_inference_check.py*

---

## 9. 修复后推理性能检查

### 9.1 生成速度 (state, 100 tok)
...
### 9.2 PPL (SFT, seq=512, 50 samples)
...
## 11. 训练时集成 State Cap 验证

### 11.1 训练 Loss 对比 (WDLM 从头训练 200 steps)
